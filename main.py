...
# (Keep your existing helper functions: show_help, show_inventory, show_victory_screen, handle_buy, handle_use, handle_go, handle_fight, rest_at_guild, accept_quest, show_quest_board, show_crafting, get_random_drop)
