...
def show_title_screen():
    ...
    time.sleep(0.8)
    print(Fore.WHITE + "\nYou stand before the grand doors of the Silver Blade Guild...")
    time.sleep(1.2)
    print(Fore.GREEN + "A new adventure begins...\n")
...
# (Keep all your helper functions from previous version: show_help, show_inventory, show_victory_screen, etc.)
...
# ... (All other functions remain the same as in the previous commit)
